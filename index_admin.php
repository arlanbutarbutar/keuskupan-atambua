...
<body>
  ...
  if ($page == "beranda") {
    ...
    detailDaftar();
  } else if ($page == "detailDaftar1") {
    detailDaftar1();
  } else if ($page == "hapusDaftar") {
    hapusDaftar();
  } else if ($page == "hapusDaftar1") {
    hapusDaftar1();
  } else if ($page == "gereja") {
    gereja();
    ...
    hapusAdmin();
  } else if ($page == "profilTambahOp") {
    profilTambahOp();
  } else if ($page == "profilEditPass") {
    profilEditPass();
  } else if ($page == "gerejaTambah") {
    gerejaTambah();
  } else if ($page == "daftarTambah") {
    daftarTambah();
  } else if ($page == "daftarTambah1") {
    daftarTambah1();
  } else if ($page == "tambahKutipan") {
    tambahKutipan();
  } else if ($page == "detailKutipan") {
    detailKutipan();
  } else if ($page == "hapusKutipan") {
    hapusKutipan();
  } else if ($page == "tambahInfKeus") {
    tambahInfKeus();
  } else if ($page == "detailInfKeus") {
    detailInfKeus();
  } else if ($page == "hapusInfKeus") {
    hapusInfKeus();
  } else if ($page == "tambahRomo") {
    tambahRomo();
  } else if ($page == "detailRomo") {
    detailRomo();
  } else if ($page == "hapusRomo") {
    hapusRomo();
  } else if ($page == "tambahKeuskupan") {
    tambahKeuskupan();
  } else if ($page == "detailKeuskupan") {
    detailKeuskupan();
  } else if ($page == "hapusKeuskupan") {
    hapusKeuskupan();
  } else if ($page == "tambahParoki") {
    tambahParoki();
  } else if ($page == "detailAlbumParoki") {
    detailAlbumParoki();
  } else if ($page == "detailParoki") {
    detailParoki();
  } else if ($page == "hapusParoki") {
    hapusParoki();
  } else if ($page == "gallery") {
    gallery();
  } else if ($page == "tambahGallery") {
    tambahGallery();
  } else if ($page == "detailGallery") {
    detailGallery();
  } else if ($page == "hapusGallery") {
    hapusGallery();
  } else {
    beranda();
  }
    ...
    <div class="copyright">
      <div class="row">
        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
          &copy; <a href="#">Reinaldo Ivan</a>, All Right Reserved.<br>
          <div class="h-100 d-inline-flex align-items-center">
